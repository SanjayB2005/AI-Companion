"""
Django settings for emotion_companion project.
...
ROOT_URLCONF = 'emotion_companion.urls'
...
WSGI_APPLICATION = 'emotion_companion.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='emotion_companion'),
...
# Relaxed password validation for development - strengthen for production
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': 'django.contrib.auth.password_validation.MinimumLengthValidator',
        'OPTIONS': {
            'min_length': 6,  # Minimum 6 characters for development
        }
    },
    # Commented out for easier testing in development
    # {
